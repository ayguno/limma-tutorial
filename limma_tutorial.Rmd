...
- Each row is a Group.
- For each comparison, the contributing groups are either 1 or -1 depending on the order 
...
three.group.significance <- topTable(fit.3.group, coef = "GroupK48", adjust.method = "fdr",
                                   number = nrow(data.mat), sort.by = "none", confint = TRUE)
```
