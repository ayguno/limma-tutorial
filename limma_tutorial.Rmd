...
**Question: now our question becomes: Which log gene expression ratios (relative to a reference (control or denominator)) is different from zero? in Tetra_Ub_K48_iDUB condition (class).**
...
row.names(data.K48) <- data.mat$accession_number # We stick the gene names into the expression set as row.names
```
