...
3. Which genes **respond differently** to a given treatment  
...
This **independence** is important because, if we have resampled from the same individual (Wild-type or Mutant), we had to take into account the correlation between the observations. This would necessiate using mixed effect models. 

## Set the factor levels correctly to define reference levels

It is especially important to define the factor levels correctly based 
